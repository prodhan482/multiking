...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/assets/css/pages/page-misc.css">
    <!-- END: Page CSS-->
</head>
<!-- END: Head-->
            ...
            <div class="misc-wrapper">
                <div class="misc-inner p-2 p-sm-3">
                    <div class="w-100 text-center">
                        <img class="img-fluid" src="/assets/images/Logo2.png" alt="Under maintenance page" /><br><br><br>
                        <h2 class="mb-1">We are launching soon 🚀</h2>
                        <p class="mb-3">We're creating something awesome. Please contact to site admin to get notified when it's ready!</p>
                    </div>
                </div>
            </div>
            <!-- / Coming soon page-->
