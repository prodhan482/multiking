        ...
        <div class="content-body">
            <div class="card" style="margin-top: 20px">
                <div class="card-header bg-white header-elements-inline">
                    <h6 class="card-title"><?php if($userInfo->user_type !== "Reseller"): ?>Reseller<?php endif; ?> Payment Return</h6>
        ...
        var app = new Vue({
            ...
            mounted() {
                ...
                this.masterTable = $('.dataTable').DataTable({
                        ...
                        "ajax": {
                            "url": '<?php echo env('APP_URL', ''); ?>/api/report/reseller_return_payment',
                            "type": "POST",
