                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" placeholder="Type Reseller name" class="form-control" id="store_owner_name">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-sm-3">Phone Number</label>
                                        <div class="col-sm-9">
                                            <input type="text" placeholder="Type Phone Number" class="form-control" id="store_phone_number">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label col-sm-4">Commission</label>
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input type="number" placeholder="Put Commission %" class="form-control" value="2" id="commissionPercent" onkeyup="theInstance.CalculateRechargeAmount()">
                                                <div class="input-group-append">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label col-sm-4" id="selectedCurrencyTitle">BDT Rate</label>
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="selectedCurrency">&euro;</span>
                                                </div>
                                                <input type="text" placeholder="Put Bdt Amount" class="form-control" id="selectedCurrencyAmount" onkeyup="theInstance.CalculateRechargeAmount()">
                                                <div class="input-group-append">
                                                    <span class="input-group-text">.00</span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label class="col-form-label col-sm-8" id="theTotal">0.00</label>
                                    </div>
    ...
    jQuery(function(){
        theInstance.masterTable = jQuery('.dataTable').DataTable({
                ...
                buttons: [
                    ...
                    {
                        text: 'Add Return',
                        className: 'btn btn-warning btn-add-record ml-2',
                        action: function (e, dt, button, config) {
                            ...
                            theInstance.addResellerAmountReturnDialog = bootbox.dialog({
                                title: 'Add Return To Reseller.',
                                message: (
                                    '<div class="form-group"><label>Reseller</label>' +

                                    '<select class="form-control select2box3">' +
                                    '<option value="">Select A Reseller</option>'+strDropDown+
                                    '</select>' +

                                    '</div>'

                                    +'<div class="form-group"><label>Amount </label><input class="form-control" id="theAmount" type="text" placeholder="Put Returned Amount."></div>'
                                    +'<div class="form-group"><label>Note</label><textarea class="form-control" id="addResellerReturnDialog_note" rows="3" placeholder="Enter your note here."></textarea></div>'
                                ),
                                //centerVertical:true,
                                buttons: {
                                    cancel: {
                                    ...
                                    ok: {
                                        ...
                                        callback: function(){
                                            ...
                                            jQuery.ajax({
                                                ...
                                                url: "<?php echo env('APP_URL', ''); ?>/api/store/"+$('.select2box3').find(':selected').val(),
                                                dataType: 'json',
                                                data: JSON.stringify({
                                                    "store_id":$('.select2box3').find(':selected').val(),
                                                    "new_balance":$('#theAmount').val(),
                                                    "note":$('#addResellerReturnDialog_note').val()
                                                }),
                                                statusCode: {
                                                    200: function() {
                                                        theInstance.hideWaitingDialog();
                            ...
                            theInstance.addResellerAmountReturnDialog.on('shown.bs.modal', function(e){
                                $('.select2box3').select2({'width':'100%'});
                            });
                        }
                    },
                    <?php /* ?>
                    {
                        text: 'Add Return (EURO)',
                        ...
                        action: function (e, dt, button, config) {
                            ...
                            theInstance.addResellerAmountReturnDialog = bootbox.dialog({
                                title: 'Add Return To Reseller (EURO).',
                                message: (
                                    '<div class="form-group"><label>Reseller</label>' +
                                    ...
                                    +'<div class="form-group"><label>Amount (EURO) </label><input class="form-control" id="theAmount" type="text" placeholder="Put Returned Amount. (EURO)"></div>'

                                    +'<div class="form-group"><label>Euro Conversation Rate </label><input class="form-control" id="theConvRate" value="100" type="text" placeholder="Put Euro Conversation rate"></div>'
                        ...
                        'render': function (data, type, full, meta)
                        {
                            ...
                            if(theInstance.parent_store_id == "0")
                            {
                                return '<div class="btn-group btn-group-sm">'+
                                    ...
                                    '<button type="button" class="btn btn-success addBalance" data-id="'+info.split('|')[0]+'" data-conversion_rate="'+info.split('|')[2]+'" data-base_currency="'+info.split('|')[3]+'" data-id="'+info.split('|')[0]+'" data-base_add_balance_commission_rate="'+info.split('|')[4]+'">Add Balance</button>'+
                                    '</div>';
                            }
                ...
                "ajax": {
                    ...
                    complete: function(data)
                    {
                        ...
                        $(".the_page_title").html('<h6 class="card-title">Reseller List</h6>');
