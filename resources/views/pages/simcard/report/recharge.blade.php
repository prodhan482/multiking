            ...
            <section class="app-user-list">
                ...
                <div class="card">
                    <div class="card-header bg-white header-elements-inline">
                        <h6 class="card-title">Sold SIMCARD Overview</h6>
                    </div>
                        ...
                        <table class="table dataTable no-footer">
                            <thead>
                                <tr>
                                    ...
                                    <th v-for="item in simcardOffers" v-html="item.title"></th>
        ...
        var app = new Vue({
            ...
            methods: {
                loadTableData()
                {
                    ...
                    axios.post("<?php echo env('APP_URL', ''); ?>/api/simcard/report/recharge", formData,
                        {
                            headers: {
                                Authorization: '<?php echo session('AuthorizationToken'); ?>'
                            },
                        }).then(response => {
                        theInstance.simcardOffers = response.data.simcard_offer
                        ...
                        setTimeout(function () {
                            theInstance.masterTable = $('.table').DataTable( {
                                ...
                                paging:         false,
                                "language": {
                                    "emptyTable": "No Data Found. <b>You need to Select a Reseller and a Product and Search again.</b>",
                                },
                                "ordering": false,
                                "searching": false,
                                "info": false,
