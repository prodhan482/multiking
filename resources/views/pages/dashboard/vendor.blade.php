                                ...
                                },
                                {
                                    ...
                                    'render': function (data, type, row, meta)
                                    {
                                        ...
                                        return '<div class="btn-group-sm">'+
                                            ...
                                            ((info.split('|')[1] === "progressing" && !theInstance.isMobile())?'<a class="btn btn-primary shareBtt" href="https://api.whatsapp.com/send?text=kingmulti.net%0aNumber '+row[2]+'%0aAmount '+row[3]+'%0aType '+row[1]+'%0aRefer ID '+row[0]+'%0aReseller: '+row[8]+'%0aParent: '+row[9]+'" target="_blank" data-id="'+info.split('|')[0]+'">Share</a>':'')+
