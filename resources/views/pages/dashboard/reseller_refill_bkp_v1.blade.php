...
<div class="app-content content " id="app">
                            ...
                            <div class="card-body">
                                <div class="row match-height">
                                    <div :class="[(isMobile()?'col-sm-6':'col')]" style="text-align: center"
                                        ...
                                        <a href="javascript:void(0)" v-on:click="selectTheOption(option.mfs_id, option.mfs_name, option.image_path)">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="basicInput1" placeholder="01XXXXXXXXX" v-model="request.mobile_number">
                                </div>
                                <div class="form-group">
                                    <label>Type</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="In Amount" v-model="request.receive_money" v-on:keyup="comChargClacu2">
                                        <span class="input-group-append">
                                          <span class="input-group-text"><?php echo strtoupper(implode(" ", explode("_", $userInfo->storeBaseCurrency))); ?></span>
                                        </span>
                                    </div>
    ...
    <div class="modal fade setServiceChargeSlab" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        ...
        var app = new Vue({
            ...
            methods: {
                    ...
                    this.masterTable = $('.dataTable').DataTable({
                            ...
                            "ajax": {
                                ...
                                complete: function(data)
                                {
                                    ...
                                    theInstance.selectTheOption("<?php echo $_GET['mfs']; ?>", theInstance.mfs_list_by_id["<?php echo $_GET['mfs']; ?>"].mfs_name, theInstance.mfs_list_by_id["<?php echo $_GET['mfs']; ?>"].image_path)
                                    <?php endif; ?>
                                },
                ...
                comChargClacu() {
                    ...
                    theInstance.request.visualCharge = parseFloat((i * parseFloat(theInstance.request.send_money)) * theInstance.request.charge)
                ...
                selectTheOption(mfs_id, selected_mfs_name, selected_mfs_logo_path)
                {
