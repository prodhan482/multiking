...
(function (root, factory) {
  ...
  function constructDialog($dialog) {
    ...
    return $(
      ...
      '</div>'+
        ...
        '<div id="WD_cancelBtt" class="pull-right d-none"><br><button type="button" onclick="window.location.reload();" class="btn btn-danger btn-sm">Cancel</button></div>'+
  ...
  return {
    ...
    show: function (message, options) {
      ...
      if(!isNaN(settings.defaultTimeOutSec) && settings.defaultTimeOutSec > 0)
      {
          setTimeout(function () {
              $("#WD_cancelBtt").removeClass("d-none");
          }, (settings.defaultTimeOutSec * 1000));
      }
    ...
    setTimeout:function (timeOutSec = 60) {
        config.defaultTimeOutSec = timeOutSec
        if(!isNaN(config.defaultTimeOutSec) && config.defaultTimeOutSec > 0)
        {
            setTimeout(function () {
                $("#WD_cancelBtt").removeClass("d-none");
