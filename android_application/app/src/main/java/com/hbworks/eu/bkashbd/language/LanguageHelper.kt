package com.hbworks.eu.bkashbd.language
...
//            setApplicationLocale(context, locale)
    ...
    private fun load(context: Context): Locale {
        ...
        val language = preferences.getString(SELECTED_LANGUAGE, LanguageLocales.English.language)
        val country = preferences.getString(SELECTED_COUNTRY, LanguageLocales.English.country)
