          ...
          title: Column(
            ...
            children: <Widget>[
              ...
              Text("Note: ${object[5]}",
                  style: MyText.subtitle(context)!.copyWith(
                      color: Colors.grey[800], fontWeight: FontWeight.normal)),
              (object[8]!.length > 2 ? Container(height: 5.sp) : Container()),
              (object[8]!.length > 2
                  ? Text("Vendor: ${object[8]}",
                      style: MyText.subtitle(context)!.copyWith(
                          color: Colors.grey[800],
                          fontWeight: FontWeight.normal))
                  : Container()),
              (object[6]!.length > 2 ? Container(height: 5.sp) : Container()),
              (object[6]!.length > 2
                  ? Text("Vendor Note: ${object[6]}",
                      style: MyText.subtitle(context)!.copyWith(
                          color: Colors.grey[800],
                          fontWeight: FontWeight.normal))
                  : Container()),
              Container(height: 5.sp),
              Text("Created on: ${object[1]}",
                  style: MyText.subtitle(context)!.copyWith(
                      color: Colors.grey[800], fontWeight: FontWeight.normal)),
              Container(height: 5.sp),
              Text("Last Updated on: ${object[10]}",
                  style: MyText.subtitle(context)!.copyWith(
                      color: Colors.grey[800], fontWeight: FontWeight.normal))
            ],
          ),
          children: <Widget>[
            Wrap(
              ...
              children: <Widget>[
                    ...
                    ? GetBuilder<HomeController>(
                        ...
                        builder: (controller) => RaisedButton(
                              ...
                              onPressed: () {
                                _showDialog(
                                    context,
                                    "Reinitialize Recharge.",
                                    "Are you sure about reinitialize this recharge?",
                                    "Cancel",
                                    () {},
                                    "Reinitialize", () {
                                  ProgressHud.showLoading();
                                  controller.reInitRejectedRecharge(
                                      object[12]!.split("|")[0], () {
                                    doReload();
                                    ProgressHud.dismiss();
                                  });
                ...
                ((object[9]! == "Progressing" || object[9]! == "Requested")
                    ? GetBuilder<HomeController>(
                        init: HomeController(),
                        builder: (controller) => RaisedButton(
